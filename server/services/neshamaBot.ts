...
const emotionAwarePrompt = (userMessage: string) => `
...
export async function generateComfortingResponse(userMessage: string): Promise<string> {
  try {
...
export async function generateGPTComfortResponse(userMessage: string): Promise<string> {
  try {
