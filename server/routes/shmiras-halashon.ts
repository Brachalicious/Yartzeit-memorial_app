...
router.post('/', async (req, res) => {
  try {
    const {
      date_recorded,
      positive_speech_count = 0,
      avoided_lashon_hara = 0,
      gave_compliments = 0,
      spoke_words_of_torah = 0,
      helped_through_speech = 0,
      reflection_notes,
      daily_goal,
      challenges_faced,
...
router.put('/:id', async (req, res) => {
  try {
    ...
    if (positive_speech_count !== undefined) updateData.positive_speech_count = positive_speech_count;
    if (avoided_lashon_hara !== undefined) updateData.avoided_lashon_hara = avoided_lashon_hara;
    if (gave_compliments !== undefined) updateData.gave_compliments = gave_compliments;
    if (spoke_words_of_torah !== undefined) updateData.spoke_words_of_torah = spoke_words_of_torah;
    if (helped_through_speech !== undefined) updateData.helped_through_speech = helped_through_speech;
    if (reflection_notes !== undefined) updateData.reflection_notes = reflection_notes || null;
    if (daily_goal !== undefined) updateData.daily_goal = daily_goal || null;
    if (challenges_faced !== undefined) updateData.challenges_faced = challenges_faced || null;
    if (improvements_noticed !== undefined) updateData.improvements_noticed = improvements_noticed || null;
